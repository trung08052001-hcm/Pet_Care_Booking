...
class _PetAvatar extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final bytes = _imageBytesFromDataUrl(pet.imageUrl);
...
Future<void> _showAddPetSheet(BuildContext context) {
...
class _PetTypeSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const items = [
      ...
      _PetTypeOption(type: 'rabbit', label: 'Thỏ', icon: Icons.emoji_nature_rounded),
